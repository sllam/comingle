...
public class Accept extends Message implements Serializable {
	...
	public final NodeInfo peer;
	
	public Accept(NodeInfo peer) {
		this.peer = peer;
	}
	
	public String toString() {
		return String.format("Accept(%s)", peer);
	}
	
	public void enter(MessageHandler manager) { manager.processMessage(this); }
	
	private static final long serialVersionUID = 5070886265653802135L;
