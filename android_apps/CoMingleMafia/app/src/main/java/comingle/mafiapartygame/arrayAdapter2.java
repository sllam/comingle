 ...
 */
public class arrayAdapter2 extends android.widget.ArrayAdapter<VoteSlot> {
    private int voteId;
    private int nameId;
    ...
    public arrayAdapter2(Activity act,int arrayAdapterId, int nameId,int voteId, ArrayList<VoteSlot> votes){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(selected_vote != null) {
            ...
            if(vote != null) {
                ...
                for(int i=0;i<selected_vote.votees.size();i++){
                    votees.add(selected_vote.votees.get(i).name);
                }
                vote.setText(String.format("%s",votees.toString()));
            }
