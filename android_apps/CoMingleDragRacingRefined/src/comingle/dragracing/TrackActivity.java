...
public class TrackActivity extends FragmentActivity {
	...
	private CoMingleAndroidRuntime<Dragracing> dragracingRuntime;
    ...
    public void onCreate(Bundle savedInstanceState) {
    	...
    	dragracingRuntime = new CoMingleAndroidRuntime<Dragracing>(this, Dragracing.class, DR_ADMIN_PORT, DR_FACT_PORT, DR_REQ_CODE);
    	...
    	dragracingRuntime.initStandardDirectorySetup(R.layout.peer_list_row, R.id.peer_name, R.id.peer_loc, R.id.peer_ip, postDirChoiceListener);
    ...
    private void setupDirectory() {
		...
		dragracingRuntime.getDirectory().addNetworkStatusChangedListener(new NetworkStatusChangedListener() {
			...
			public void doWifiConnectionStatusChangedAction(boolean connected) {
				if(!postedWifiComplaint && dragracingRuntime.getDirectory().isWifiEnabled() && !dragracingRuntime.getDirectory().isWifiConnected()) {
    ...
    protected void onResume() {
    	super.onResume();
    	startTimerIfNeeded();
    	dragracingRuntime.resumeNetworkNotifications();
    }
    ...
    protected void onPause() {
    	super.onPause();
    	stopTimerIfNeeded();
    	dragracingRuntime.pauseNetworkNotifications();
    }
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		this.dragracingRuntime.handleOnActivityResults(requestCode);
	}
