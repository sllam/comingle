...
public class FileSelector {
	 ...
	 *            Array with filters
	 */
	public FileSelector(final Context context, final FileOperation operation, final OnHandleFileListener onHandleFileListener
                           ,final String[] fileFilters, final String title) {
		mContext = context;
		...
		mDialog.setTitle( title ); // mCurrentLocation.getAbsolutePath());
